...
class __TwigTemplate_3519735d877606ba3cf5ec6574d0af0883ea757ef5cd52e5384c90f85477f59a extends Template
{
    private $source;
    private $macros = [];
...
($context["item"] ?? null), "fields", [], "any", false, false, false, 42)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["required"] ?? null) : null), __("Required", "formcreator"), ["add_field_class" => "plugin_formcreator_required", "label_class" => "col-xxl-4", "input_class" => "col-xxl-8"]], 40, $context, $this->getSourceContext());
    ...
    ";
        // line 57
        yield CoreExtension::callMacro($macros["fields"], "macro_dateField", ["default_values", (($__internal_compile_1 = CoreExtension::getAttribute($this->env, $this->source,         // line 59
...
";
    ...
    {
        return new Source("", "@formcreator/field/datefield.html.twig", "C:\\xampp\\htdocs\\glpi\\plugins\\formcreator\\templates\\field\\datefield.html.twig");
    }
}
